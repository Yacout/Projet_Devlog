class noeud
{
	...
	public: 
		...
		noeud(int op, int var1, int var2); 
		//ctor avec deux noeuds
		noeud(int op, noeud* noeud1, noeud* noeud2);
		//ctor avec un noeud et une variable
		noeud(int op, int var, noeud* noeud);
		//ctor avec deux constantes
		noeud(int op, bool const1, bool const2);
		//ctor avec une constante et un noeud
		noeud(int op, bool const1, noeud* noeud);
		//ctor avec une constante et une variable
		noeud(int op, bool const1, int var1);
		//ctor pour not avec une variable
		noeud(int op, int var);
		//ctor pour not avec un noeud
		noeud(int op, noeud* noeud);
